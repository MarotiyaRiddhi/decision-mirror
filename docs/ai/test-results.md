...
| - | -------- | --------------- | ---------- | ------------ | ------ |
| 1 | How do I install dependencies, bind env, and build this project? | Yes | `AGENTS.md`, `README.md`, L0, `01_setup`, `05_workflows`, `docs/GUIDE.md`, `package.json` | L0+L1 | Pass |
...
| # | Question | Answer Correct? | Files Read | Level Loaded | Result |
| - | -------- | --------------- | ---------- | ------------ | ------ |
| 3 | How do I run the API contract validation flow? | Yes | `package.json`, `01_setup`, `03_code_map`, `04_conventions`, `06_interfaces`, `docs/GUIDE.md` | L1 | Pass |
...
| 8 | What docs must change when a workflow, interface, or recipe stable contract changes? | Yes | `AGENTS.md`, `CONTRIBUTING.md`, `docs/GUIDE.md`, L0, `RECIPE.md`, `01_setup`, `04_conventions`, `05_workflows`, `06_interfaces`, `07_gotchas` | L1+Recipe | Pass |

### Development

| # | Question | Answer Correct? | Files Read | Level Loaded | Result |
| - | -------- | --------------- | ---------- | ------------ | ------ |
| 5 | How would I change the agent prompt/model/VAD settings safely? | Yes | `AGENTS.md`, `README.md`, `docs/GUIDE.md`, `RECIPE.md`, `03_code_map`, `05_workflows`, `invite_agent_config.md` | L1+L2 | Pass |

### Deep Dive

| # | Question | Answer Correct? | Files Read | Level Loaded | Result |
| - | -------- | --------------- | ---------- | ------------ | ------ |
| 6 | Why does transcript rendering remap `uid="0"` and keep `INTERRUPTED` turns? | Yes | `AGENTS.md`, `docs/TEXT_STREAMING_GUIDE.md`, `docs/GUIDE.md`, `RECIPE.md`, `04_conventions`, `07_gotchas`, `transcript_pipeline.md` | L1+L2 | Pass |
| 7 | How does token renewal handle RTC and RTM identities? | Yes | `README.md`, `docs/TEXT_STREAMING_GUIDE.md`, `02_architecture`, `04_conventions`, `08_security`, `token_model.md` | L1+L2 | Pass |
